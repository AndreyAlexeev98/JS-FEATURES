// Самописная легкая реализация библиотеки Tween, инкапсулирующая низкоуровневые математические рассчеты и предоставляющая наружу удобные методы управления анимацией
...
export class Tween {
  ...
  update(currentTime) {
    ...
    for (let key in this._params) {
      ...
      this._target[key] =
        this._startValues[key] + this._deltaValues[key] * this._progress;
    }
  }
}
